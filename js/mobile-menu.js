document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".i-navigation-list");
  const headerRef = document.querySelector(".i-header");
  const navigationRef = document.querySelector(".i-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".i-toggle-button img");
